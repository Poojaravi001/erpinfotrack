      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="<?php echo e(route('users.index')); ?>" class="nav-link"><i data-feather="user"></i><span>Users</span></a>
            </li>
            ...
            <li class="dropdown">
              ...
              <li><a class="nav-link" href="<?php echo e(route('courses.index')); ?>">Courses </a></li>
              <li><a class="nav-link" href="<?php echo e(route('enquiry.index')); ?>">Enquiry </a></li>
              <li><a class="nav-link" href="<?php echo e(route('enquiry_followup.create')); ?>">Follow Up</a></li>
              <li><a class="nav-link" href="<?php echo e(route('admission.index')); ?>">Admission</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="<?php echo e(route('feesettings.index')); ?>">Fees</a></li>

                <li><a class="nav-link" href="<?php echo e(route('fees.create')); ?>">Fees Collection </a></li>
              </ul>
            </li>
...
</html><?php /**PATH D:\xampp\htdocs\erp\resources\views/layouts/app.blade.php ENDPATH**/ ?>