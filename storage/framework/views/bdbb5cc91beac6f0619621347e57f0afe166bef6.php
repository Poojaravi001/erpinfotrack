...
<div class="form-group col-lg-3">
  ...
  <select name="health_issues" x-model="enquiry.health_issues" id="health_issues">
    ...
    <option value="<?php echo e($issue->health_issues); ?>"><?php echo e($issue->health_issues); ?></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  </select>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erp\resources\views\admission\create.blade.php ENDPATH**/ ?>